...
.您需要什么？ #8217 ；将需要什么
* 您已复制  the installation ID and cluster ID of a storage cluster asset,存储集群 ID 和安装 ID 要添加的任何存储集群。
...
NOTE: 确保已按照中的步骤进行操作  the installation ID and cluster ID of a storage cluster asset 然后继续。
