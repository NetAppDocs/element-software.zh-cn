...
---
= 启动远程NetApp支持会话(Element 12.3及更早版本)
:allow-uri-read: 


[role="lead"]
如果您运行的是Element 12.3及更早版本、并且需要SolidFire 全闪存存储系统的技术支持、则NetApp支持部门可以远程连接到您的系统。要启动会话并获得远程访问， NetApp 支持部门可以与您的环境建立反向安全 Shell （ SSH ）连接。
