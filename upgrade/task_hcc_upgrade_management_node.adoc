...
您可以将管理节点从12.3.x或更高版本原位升级到12.5或更高版本、而无需配置新的管理节点VM。
...
.步骤
. 使用SSH或控制台访问登录到管理节点VM。
. 将适用于Element的软件从NetApp支持站点下载 https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["管理节点 ISO"^]到管理节点虚拟机。
+
