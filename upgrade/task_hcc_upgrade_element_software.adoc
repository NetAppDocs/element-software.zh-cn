...
.步骤
. 下载存储升级软件包；转到 Element 软件 https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["下载页面"^] 并将最新的存储节点映像下载到非管理节点设备。
+
...
.您需要什么？ #8217 ；将需要什么
. 转至 Element 软件 https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["下载页面"^]。
