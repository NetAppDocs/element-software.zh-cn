...
* 您要升级到 VCP 4.7 ， 4.6 ， 4.5 或 4.4 。
* 您要升级到 7.0 ， 6.7 或 6.5 HTML5 vSphere Web Client 。
* 您要升级到 6.7 或 6.5 Flash vSphere Web Client 。



IMPORTANT: 此插件与 vSphere Web Client 6.7 U2 for Flash ， 6.7 U3 （ Flash 和 HTML5 ）和 7.0 U1 兼容。此插件与 HTML5 vSphere Web Client 6.7 U2 版不兼容。有关受支持的 vSphere 版本的详细信息，请参见的发行说明 https://docs.netapp.com/us-en/vcp/rn_relatedrn_vcp.html#netapp-element-plug-in-for-vcenter-server["您的插件版本"^]。
...
* * vSphere Web Client* ：对于 vSphere 6.5 和 6.7 ，在开始任何插件升级之前，您已从 vSphere Web Client 中注销。如果不注销，这些版本的 Web 客户端将无法识别在此过程中对插件所做的更新。对于 vSphere 7.0 ，您无需从 Web 客户端注销。
...
NOTE: 如果未显示 vCenter 插件图标，请参见适用于 vCenter Server 的 Element 插件文档，了解如何对插件进行故障排除。
